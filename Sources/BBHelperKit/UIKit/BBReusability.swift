...
public protocol BBReusable: class {
    static var identifier: String { get }
}

public extension BBReusable {
...
extension UITableViewCell: BBReusable { }

extension UICollectionViewCell: BBReusable { }

extension UITableViewHeaderFooterView: BBReusable { }
...
public extension NSCollectionView {
    ...
    func register<ViewClass: NSView & BBReusable>(_ viewClass: ViewClass.Type,
    ...
    func makeSupplementaryView<ViewClass: NSView & BBReusable>(_ viewClass: ViewClass.Type,
